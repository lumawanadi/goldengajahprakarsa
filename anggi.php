      ...
      <div class="container">
        <div class="row mb40">
          <div class="col-md-6 col-md-push-6 probootstrap-animate">
            <h2>Description</h2>
            <p>Halaman ini memuat Portofolio dari Anggi Art, dimana halaman ini membuat seluruh karya dari Anggi Putri Kristiadji.</p>
          </div>
        </div>
        <!-- END row -->
        <?php
          	$q = query("SELECT *FROM porto WHERE ket='3'");
          	while ($data = row($q)) {
        ?>
